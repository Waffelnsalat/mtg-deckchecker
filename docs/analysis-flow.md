...
Rules reference (checked 2026-09-25): the user-provided October 2025 Commander Brackets overview, [Wizards' October 2025 bracket expectations](https://magic.wizards.com/en/news/announcements/commander-brackets-beta-update-october-21-2025), and [February 2026 Game Changer update](https://magic.wizards.com/en/news/announcements/commander-brackets-beta-update-february-9-2026). The distinction between adjacent brackets is theme (1/2), card choices and mechanical focus (2/3), speed (3/4), and cEDH metagame intent (4/5). A two-card game-ending, lockout, or infinite combo does not fit Core, while Upgraded expects no such win before turn six. Brackets 1 through 4 generally expect players to see at least 9, 8, 6, and 4 turns, respectively; cEDH can end on any turn. The numeric power and speed thresholds in this project are local estimates, not official Wizards cutoffs; actual win turns, thematic exceptions, and deck intent still need a pregame conversation.
